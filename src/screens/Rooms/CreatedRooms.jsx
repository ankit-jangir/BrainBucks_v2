...
export default function CreatedRooms({navigation}) {
  ...
  useEffect(() => {
    if (data?.get_created_rooms.error) {
      ToastAndroid.show(data?.get_created_rooms.error, ToastAndroid.SHORT);
              ...
              <View style={styles.roomContainer}>
                ...
                <View style={styles.memberHolder}>
                  <Text style={styles.memberText}>
                    ...
                    <Text style={{color: ColorsConstant.Black}}>
                      {item.capacity}
                    </Text>
                  </Text>
                ...
                <View>
                  <View
                    style={[
                      styles2.textP,
                      {flexDirection: 'row', justifyContent: 'auto', gap: 25},
                    ]}>
                    <View
                      style={[
                        styles2.Cview,
                      ...
                      <Text style={[styles2.textC, {color: '#000'}]}>
                        Room hash:
                      </Text>
                      <Text
                        style={[
                      ...
                      {item.room_hash && (
                        <TouchableOpacity
                          ...
                          <Image
                            ...
                            source={require('../../assets/img/copyk.png')}
                          />
                        </TouchableOpacity>
                      )}
                    </View>
      ...
      <Modal
        ...
        <View
          ...
          <Text
            ...
            Delete {currentRoom?.room_name} Room
          </Text>
          <View
            style={{
              justifyContent: 'space-around',
            ...
            <TouchableOpacity
              ...
              style={{
                backgroundColor: ColorsConstant.RedLight,
                paddingVertical: 10,
            ...
            <TouchableOpacity
              ...
              style={{
                backgroundColor: ColorsConstant.GrayyColor,
                paddingVertical: 10,
                paddingHorizontal: 20,
              }}>
