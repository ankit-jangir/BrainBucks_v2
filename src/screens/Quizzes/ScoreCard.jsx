...
export default function ScoreCard({ navigation, route }) {
  ...
  const downloadPDF = async (data) => {
    ...
    config({
      ...
      .fetch('POST', 'https://your-server-url-to-convert-html-to-pdf', {
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={[StyleConstants.safeArView, { backgroundColor: "#701DDB" }]}>
        <View style={styles.Container}>
          ...
          <TouchableOpacity onPress={()=>{navigation.navigate('QuizzesResultRewards')}}>
      ...
      <View style={[StyleConstants.safeArView, { borderColor: "#CFCFCF" }]}>
        <View>
          <View style={styles.View6Q}>
            ...
            <View style={styles.View9Q}>
              <Text style={[styles.View8Q,{color:item.my_answer === item.correct_answer?'green':'red'}]}>{item.my_answer}</Text>
            </View>
            <View style={styles.View10Q}>
