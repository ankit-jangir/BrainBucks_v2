...
export default function QuizDetails({navigation, route}) {
            ...
            <View key={JSON.stringify(data)} style={{flex: 1, margin: 20}}>
              ...
              <View>
                <Text
                  ...
                  <Text style={{color: 'rgb(138,138,138)'}}>
                    Number of Questions :
                  </Text>{' '}
                  {data?.total_num_of_quest}
                </Text>
                <Text
                  style={{
                    fontSize: 14,
          ...
          <View style={styles.RulesPV2}>
            <View style={styles.RulesPV3}>
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.dispatch(
                    StackActions.replace('StartExam', {id: route.params.id}),
                  ),
