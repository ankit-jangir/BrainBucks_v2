    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      {loading ? (
        ...
        <View style={{height: 300, backgroundColor: 'transparent'}}>
          <NoDataFound
            scale={0.7}
            message={'No Tickets. Create One To See Here'}
            actionText={'Refresh'}
            action={getTickets}
          />
        </View>
              ...
              <TouchableOpacity
                ...
                <View style={styles.ticketview}>
                  ...
                  <Text style={{color: 'black', fontSize: 15}}>
                    Last Updated: {item.update_on}
                  </Text>
                  <Text style={{color: !item.is_closed ? 'blue' : 'gray'}}>
                    {!item.is_closed ? 'Active' : 'Closed'}
                  </Text>
                </View>
                <Image
                  style={{width: '8%', height: 30, objectFit: 'contain'}}
