...
export default function HomeCourses() {
  ...
  const {data, isFetching} = useQuery({
    queryKey: ['homePaidCourses'],
    queryFn: couServ.getPaidCourses,
  });
  ...
  return (
    <>
                ...
                <View style={[styles2.centeredView, {margin: 10}]}>
                  <View
                    ...
                    <View style={styles2.buttonV}>
                      <TouchableOpacity
                        onPress={() => {
                          setCurrentCourse(current), setBuyModalVisible(true);
                        }}
      ...
      <Modal
        contentContainerStyle={{zIndex: 200}}
        ...
        <View
          key={JSON.stringify(currentCourse)}
          style={styles.buyCourseModalView}>
          <Text style={styles.buyCourseModalText}>
            Buy {currentCourse?.cou_name} Course
          </Text>
